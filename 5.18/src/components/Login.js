...
const Login = (props) => (
    <div>
        ...
        { props.error.length? (<span className="error" style={{color:'red', backgroundColor: '#b6b4b4', border:'2px solid red', padding:'5px'}}>{props.error}</span>):(<span></span>) }
        <br/><br/>
        ...
        <br/><br/>
        <button type="button" id="login-button" onClick={props.submitLoginForm}>Log In</button>    
        </form>
    </div>
)
